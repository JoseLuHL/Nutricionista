...
{
    public static class ClsSqlServer
    {

        //private static string ValorConfig;
        ...
        {
            string conexionTxt;
            conexionTxt = System.Windows.Forms.Application.StartupPath + @"\conexion\conexion.txt"; //ARCHIVO DE TEXTO PARA GUARDAR DATOS
        ...
        public static void Guardar_Arcivo(string direcionIMG, string NombreCarpeta, string nombreArchivo, string extension)
        {
            try
            {
                //Direcion que contiene la carpeta del paciente, se crea con el numero de identificacion
                string CarpetaPaciente = System.Windows.Forms.Application.StartupPath + @"\" + NombreCarpeta + @"\";
                ...
                if (Directory.Exists(CarpetaPaciente))
                {
                    ...
                    File.Copy(direcionIMG, CarpetaPaciente + nombreArchivo + "." + extension, true);
                }
                else
                {
